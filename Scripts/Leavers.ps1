...
$DeptMap = @{
    "Sales"       = @{ UserOU = "OU=Users,OU=Sales,OU=Corp,DC=robslab,DC=local" }
    "IT"          = @{ UserOU = "OU=Users,OU=IT,OU=Corp,DC=robslab,DC=local" }
    "HR"          = @{ UserOU = "OU=Users,OU=HR,OU=Corp,DC=robslab,DC=local" }
    "Finance"     = @{ UserOU = "OU=Users,OU=Finance,OU=Corp,DC=robslab,DC=local" }
    "Engineering" = @{ UserOU = "OU=Users,OU=Engineering,OU=Corp,DC=robslab,DC=local" }
}
